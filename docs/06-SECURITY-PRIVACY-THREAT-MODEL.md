...
- Examples render user content through WordPress escaping and KSES-aware paths.
- Dialog and navigation examples avoid unsafe HTML injection.
- External demos use strict content-security guidance and no analytics by default.
- Test artifacts redact personal data and never record user audio without consent.
