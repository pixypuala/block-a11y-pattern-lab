...
|---|---|---|
| v0.1 | disclosure, tabs and test schema | All milestone acceptance and audit gates |
| v0.2 | dialog/navigation and manual evidence | All milestone acceptance and audit gates |
| v0.3 | forms/status/filter patterns | All milestone acceptance and audit gates |
| v0.4 | contributor-run compatibility records | All milestone acceptance and audit gates |
| v1.0 | stable pattern-contract format | All milestone acceptance and audit gates |
